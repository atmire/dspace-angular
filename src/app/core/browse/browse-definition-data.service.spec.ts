...
describe(`BrowseDefinitionDataService`, () => {
  ...
  beforeEach(() => {
    service = new BrowseDefinitionDataService(
      null,
      null,
      null,
      null,
  ...
  describe(`findAll`, () => {
    it(`should call findAll on DataServiceImpl`, () => {
      ...
      expect(dataServiceImplSpy.findAll).toHaveBeenCalledWith(
        options,
        true,
        false,
        ...linksToFollow
  ...
  describe(`findByHref`, () => {
    it(`should call findByHref on DataServiceImpl`, () => {
      ...
      expect(dataServiceImplSpy.findByHref).toHaveBeenCalledWith(
        hrefSingle,
        true,
        false,
        ...linksToFollow
  ...
  describe(`findAllByHref`, () => {
    it(`should call findAllByHref on DataServiceImpl`, () => {
      ...
      expect(dataServiceImplSpy.findAllByHref).toHaveBeenCalledWith(
        hrefAll,
        options,
        true,
        false,
