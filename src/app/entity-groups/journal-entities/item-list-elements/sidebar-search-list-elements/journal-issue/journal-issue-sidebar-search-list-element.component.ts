 ...
 */
export class JournalIssueSidebarSearchListElementComponent extends SidebarSearchListElementComponent<
  ItemSearchResult,
  Item
> {
  /**
  ...
  getDescription(): string {
    const volumeNumbers = this.allMetadataValues([
      'publicationvolume.volumeNumber',
    ]);
    const issueNumbers = this.allMetadataValues([
