...
describe('DsDynamicLookupRelationSearchTabComponent', () => {
  ...
  function init() {
    ...
    item4 = Object.assign(new Item(), {
      uuid: 'f96a385e-de10-45b2-be66-7f10bf52f765',
    });
    ...
    searchResult3 = Object.assign(new ItemSearchResult(), {
      indexableObject: item3,
    });
    searchResult4 = Object.assign(new ItemSearchResult(), {
      indexableObject: item4,
    });
    listID = '6b0c8221-fcb4-47a8-b483-ca32363fffb3';
    selection$ = observableOf([searchResult1, searchResult2]);

    results = buildPaginatedList(undefined, [
      searchResult1,
      searchResult2,
      searchResult3,
    ]);
      ...
      providers: [
        {
          ...
          useValue: {
            search: () => createSuccessfulRemoteDataObject$(results),
          },
        },
        {
  ...
  beforeEach(() => {
    ...
    component.item = Object.assign(new Item(), {
      uuid: 'e2c31c49-846d-45dc-8651-1d6f2ad8519e',
    });
    component.relationshipType = Object.assign(
  ...
  describe('selectPage', () => {
    ...
    it('should emit the page filtered from already selected objects and call select on the service for all objects', () => {
      ...
      expect(selectableListService.select).toHaveBeenCalledWith(listID, [
        searchResult1,
        searchResult2,
        searchResult4,
      ]);
  ...
  describe('deselectPage', () => {
    ...
    it('should emit the page filtered from not yet selected objects and call select on the service for all objects', () => {
      expect((component.deselectObject as any).emit).toHaveBeenCalledWith(
        searchResult1,
        searchResult2
      );
      expect(selectableListService.deselect).toHaveBeenCalledWith(listID, [
        searchResult1,
        searchResult2,
        searchResult3,
      ]);
