...
describe('RelationshipEffects', () => {
  ...
  function init() {
    ...
    rightTypeMD = Object.assign(new MetadataValue(), {
      value: rightTypeString,
    });
    relationshipID = '1234';
    ...
    mockRelationshipService = {
      getRelationshipByItemsAndLabel: () => observableOf(relationship),
    ...
    mockRelationshipTypeService = {
      getRelationshipTypeByLabelAndTypes: () => observableOf(relationshipType),
    };
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      providers: [
        ...
        {
          provide: RelationshipTypeService,
          useValue: mockRelationshipTypeService,
        },
        ...
        { provide: SelectableListService, useValue: selectableListService },
        {
          ...
          useValue: jasmine
            .createSpy('debounceTime')
            .and.returnValue((v) => v.pipe(last())),
        },
      ],
    });
  }));
  ...
  beforeEach(() => {
    ...
    identifier = (relationEffects as any).createIdentifier(
      leftItem,
      rightItem,
    ...
    describe('When an ADD_RELATIONSHIP action is triggered', () => {
      describe("When it's the first time for this identifier", () => {
        ...
        it('should set the current value debounceMap and the value of the initialActionMap to ADD_RELATIONSHIP', () => {
          ...
          expect((relationEffects as any).initialActionMap[identifier]).toBe(
            action.type
          );
          expect((relationEffects as any).debounceMap[identifier].value).toBe(
            action.type
          );
        });
      });
      ...
      describe("When it's not the first time for this identifier", () => {
        ...
        beforeEach(() => {
          (relationEffects as any).initialActionMap[identifier] =
            testActionType;
          (relationEffects as any).debounceMap[identifier] =
            new BehaviorSubject<string>(testActionType);
        });
      ...
      describe('When the initialActionMap contains an ADD_RELATIONSHIP action', () => {
        ...
        describe('When the last value in the debounceMap is also an ADD_RELATIONSHIP action', () => {
          beforeEach(() => {
            ...
            (
              (relationEffects as any).debounceTime as jasmine.Spy
            ).and.returnValue((v) => v);
          });
          it('should call addRelationship on the effect', () => {
            ...
            expect(relationEffects.mapLastActions$).toBeObservable(expected);
            expect(
              (relationEffects as any).addRelationship
        ...
        describe('When the last value in the debounceMap is instead a REMOVE_RELATIONSHIP action', () => {
          it('should <b>not</b> call removeRelationship or addRelationship on the effect', () => {
            const actiona = new AddRelationshipAction(
              leftItem,
              rightItem,
              relationshipType.leftwardType,
              '1234'
            );
            const actionb = new RemoveRelationshipAction(
              leftItem,
              rightItem,
              relationshipType.leftwardType,
              '1234'
            ...
            expect(
              (relationEffects as any).removeRelationship
            ).not.toHaveBeenCalled();
          });
        });
      });
    ...
    describe('When an REMOVE_RELATIONSHIP action is triggered', () => {
      describe("When it's the first time for this identifier", () => {
        ...
        it('should set the current value debounceMap and the value of the initialActionMap to REMOVE_RELATIONSHIP', () => {
          action = new RemoveRelationshipAction(
            leftItem,
            rightItem,
            relationshipType.leftwardType,
            '1234'
