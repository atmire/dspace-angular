...
export const MockBitstreamFormat1: BitstreamFormat = Object.assign(
  new BitstreamFormat(),
  {
...
export const MockBitstreamFormat2: BitstreamFormat = Object.assign(
  new BitstreamFormat(),
  {
...
export const MockBitstreamFormat3: BitstreamFormat = Object.assign(
  new BitstreamFormat(),
  {
...
export const MockBitstream2: Bitstream = Object.assign(new Bitstream(), {
  sizeBytes: 31302,
  content:
    'https://dspace7.4science.it/dspace-spring-rest/api/core/bitstreams/99b00f3c-1cc6-4689-8158-91965bee6b28/content',
  ...
  _links: {
    self: {
      href: 'https://dspace7.4science.it/dspace-spring-rest/api/core/bitstreams/99b00f3c-1cc6-4689-8158-91965bee6b28',
    },
    content: {
      href: 'https://dspace7.4science.it/dspace-spring-rest/api/core/bitstreams/99b00f3c-1cc6-4689-8158-91965bee6b28/content',
    },
    format: {
      href: 'https://dspace7.4science.it/dspace-spring-rest/api/core/bitstreamformats/4',
    },
...
export const MockBitstream3: Bitstream = Object.assign(new Bitstream(), {
  sizeBytes: 4975123,
  content:
    'https://dspace7.4science.it/dspace-spring-rest/api/core/bitstreams/4db100c1-e1f5-4055-9404-9bc3e2d15f29/content',
  ...
  _links: {
    self: {
      href: 'https://dspace7.4science.it/dspace-spring-rest/api/core/bitstreams/4db100c1-e1f5-4055-9404-9bc3e2d15f29',
    },
    content: {
      href: 'https://dspace7.4science.it/dspace-spring-rest/api/core/bitstreams/4db100c1-e1f5-4055-9404-9bc3e2d15f29/content',
    },
    format: {
      href: 'https://dspace7.4science.it/dspace-spring-rest/api/core/bitstreamformats/17',
    },
  ...
  bitstreams: observableOf(
    Object.assign({
      ...
      payload: {
        ...
        page: [MockBitstream1, MockBitstream2],
      },
    })
  ),
});
...
export const ItemMock: Item = Object.assign(new Item(), {
  ...
  bundles: createSuccessfulRemoteDataObject$(
    createPaginatedList([MockOriginalBundle])
  ),
  _links: {
    self: {
